...
$$ x_{k+1} - \underbrace{\left[ - \frac{a_{k+1, k+2}}{a_{k+1,k+1} + e_k a_{k+1,k}} \right]}_{e_{k+1}} x_{k+2} = \underbrace{\frac{b_{k+1} - f_k a_{k+1,k}}{a_{k+1, k+1} + e_k a_{k+1, k}}}_{f_{k+1}}$$ 
